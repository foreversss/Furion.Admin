...
public enum ErrorCode
{
    ...
    /// 该机构下有员工禁止删除
    /// </summary>
    [ErrorCodeItemMetadata("该机构下有员工禁止删除")] D2004,
    ...
    /// 权限标识格式错误
    /// </summary>
    [ErrorCodeItemMetadata("权限标识格式错误")] D4004,
    ...
    /// 该职位下有员工禁止删除
    /// </summary>
    [ErrorCodeItemMetadata("该职位下有员工禁止删除")] D6001,
    ...
    /// 已存在同名或同管理员或同主机租户
    /// </summary>
    [ErrorCodeItemMetadata("已存在同名或同主机租户")] D1300,
    ...
    /// 已存在同名业务名称
    /// </summary>
    [ErrorCodeItemMetadata("已存在同名业务名称")] D1600,
    ...
    /// 参数不能为空
    /// </summary>
    [ErrorCodeItemMetadata("参数不能为空")] D1700
}